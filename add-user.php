...
{ 
  ...
  $sqlQuery="INSERT INTO doctor(id, staffNo, title, fname, lname, email, speciality, status, created_at, role)
	VALUES('','$tempStaffNo','$tempTitle','$tempDoctorFname','$tempDoctorLname','$tempEmail','$tempSpeciality','','$currentDate','')";
...
<!-- Add new user Modal-->
<button class="btn btn-primary" href="#" data-toggle="modal" data-target="#addUserModal">Add User</button>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input class="form-control" name = "inputTitle" value= "">
          ...
          <label for="password">Staff Number</label>
          <input class="form-control" name = "inputStaffNo" value= "">
          <label for="password">Speciality</label>
          <input class="form-control" name = "inputSpeciality" value= "">
        </div>
